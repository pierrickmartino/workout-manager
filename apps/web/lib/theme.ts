...
// A named palette family from the fixed, curated catalog (CONTEXT "Skin"). Only
// PULSE exists today; #331 extends this union as the catalog grows.
export type Skin = "pulse";
