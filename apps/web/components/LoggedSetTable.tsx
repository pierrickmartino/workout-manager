...
// projection for a timed distance set), load, and RPE. Shared by the History list card and
// the record detail page so the record renders identically wherever it is shown; the amount
// and load display go through the typed formatters, never re-derived.
export function LoggedSetTable({ sets }: { sets: LoggedSet[] }) {
  return (
